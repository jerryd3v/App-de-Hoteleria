...
<head>
    ...
    <title>Eliminar Actividad | Hospedate</title>
    ...
    <div class="contenedor">
        <div class="caja">
            ...
            <div class="habitacion">
                <h2>Actividad: <span><?php echo $_GET['id_actividad'] ?></span></h2>
            </div>
            <h2 class="titulo_eliminar">¿Esta seguro que desea Eliminar esta Actividad?</h2>
            <h3 class="sub_titulo">Esta operacion es irreversible <img class="emoji" title="Triste" src="../imagenes/emoji.png"></p>
                <div class="botones">
                    ...
                    <a class="eliminar" href="eliminar.php?id_actividad=<?php echo $_GET['id_actividad'] ?>">Eliminar</a>
                </div>
        </div>
