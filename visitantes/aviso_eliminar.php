...
<head>
    ...
    <title>Eliminar Visitante | Hospedate</title>
...
<body>
    ...
    <div class="contenedor">
        <div class="caja">
            ...
            <h2 class="titulo_eliminar">¿Esta seguro que desea Eliminar este Visitante?</h2>
            <h3 class="sub_titulo">Esta operacion es irreversible <img class="emoji" title="Triste" src="../imagenes/emoji.png"></p>
                <div class="botones">
                    <a class="cancelar" href="visitantes.php">Cancelar</a>
                    <a class="eliminar" href="eliminar.php?id=<?php echo $_GET['id'] ?>">Eliminar</a>
                </div>
        </div>
